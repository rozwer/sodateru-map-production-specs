...
export function VisitConfirmation({ place, date, time, duration, origin, status, onStatus, onSave, onBack, onPlace, onExpandMap, map, busy, error, notice }: {
