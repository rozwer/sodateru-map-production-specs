...
export function DailyTrack({ date, onDate, entries, expandedId, onExpand, onEdit, onReflect, onVisit, onBack, onMenu, onRecord, map, loading, error, onRetry, onMore, confirmedPlaces, duration, missingTrack, calendar = false, onCalendar, recordedDates, onMonth }: {
 ...
 return <section className={`records-screen activity-daily ${calendar ? 'activity-calendar-screen' : ''}`}>
   ...
   <div className="activity-track-sheet">
     ...
     {!calendar && missingTrack && <p className="activity-missing-track"><RecordIcon name="info"/>{m.noTrack}</p>}
