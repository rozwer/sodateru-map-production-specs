...
export function RecordCorrection({ body, date, interpretation, purposes, onPurposes, reason, onReason, onSavePurpose, onSaveReason, onBack, onReload, error, notice, busy, currentPurposes, currentVersion }: {
  ...
  currentPurposes?: string[]; currentVersion?: number; onBack: () => void; onReload?: () => void; error?: string; notice?: string; busy?: boolean;
}) {
