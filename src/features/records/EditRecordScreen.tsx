...
export function EditRecordScreen({route,scopeKey,back,navigate,active=true}:ScreenProps & {active?:boolean}) {
 ...
 const save=async()=>{
  ...
  submitting.current=true;setBusy(true);setError('');const abort=new AbortController();controller.current=abort;
  try{
