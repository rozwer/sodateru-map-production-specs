...
export function AiConsentView({ text, enabled, place, busy, error, permissions, placePicker, textLimit = 300, onText, onEnable, onChangePlace, onRemovePlace, onCancel, onSend }: {
  text: string; enabled: boolean; place: PlacePresentation | null; busy: boolean; error: string | null;
  permissions?: ReactNode; placePicker?: ReactNode; textLimit?: number;
