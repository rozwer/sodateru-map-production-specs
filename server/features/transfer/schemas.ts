...
const planInput = obj({ id: str(80), recipeId: id, recipeVersion: int(1), region: str(300), start: position, mode: en('walking','driving'), timeBudgetMinutes: int(1,1440), preferences: str(4000,0) });
...
export const transferInputSchema = obj({ planSetId: str(80) });
