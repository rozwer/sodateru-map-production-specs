...
export type { RequestContext as AiContext } from '../core/context.ts';
import type { RequestContext as AiContext } from '../core/context.ts';
...
export type AppliedRef={type:'record'|'theme'|'insight'|'discovery'|'map-settings'|'transfer-plan-set'|'pilgrimage-plan';id:string;version:number;contentHash:string};
...
export type AiDependencies={
 ...
 assertConversationRecord(db:DatabaseSync,context:AiContext,id:string):void;
