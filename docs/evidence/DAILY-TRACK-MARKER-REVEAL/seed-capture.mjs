...
let cookie='';
const api=createApiClient({baseUrl:'http://127.0.0.1:3284/api/v1',fetch:async(url,options)=>{
...
const receipt={provenance:'User-authorized capture mock, not personal measured movement. Place/route coordinates are provider sourced, unmodified. No shared/live DB writes.',date:'2026-09-15',api:'http://127.0.0.1:3284',places:[],visits:[],segments:[]};
