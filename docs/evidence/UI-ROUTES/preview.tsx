...
function Preview() {
  ...
  const map = { summary: '地図描画はUI-MAP接続待ち', unavailable: { message: '地図描画の接続待ち（部品検証）' } };
  ...
  </main><style>{`body{margin:0;background:#e7eeee}.qa-controls{display:flex;gap:8px;align-items:center;flex-wrap:wrap;background:#fff4d4;padding:8px;font:12px system-ui;color:#554310}.qa-controls button{padding:6px}.qa-controls output{flex-basis:100%}main{max-width:390px;margin:16px auto;background:#f1f8f8;box-shadow:0 0 0 1px #bfd5dc} @media(max-width:600px){main{margin:0 auto;max-width:100%}}`}</style></>;
}
