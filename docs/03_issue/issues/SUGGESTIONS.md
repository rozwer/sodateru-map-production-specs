...
初期担当枠：D。担当者：mattsun。[GitHub #36](https://github.com/rozwer/sodateru-map-production-specs/issues/36)。[一覧](../README.md) · [共通完了条件](../execution.md#完了の扱い)。
...
- **SUGGESTIONS.complete**：今日の条件・候補生成・選択・達成。実データから候補を作り、選択/達成と停止条件を保存・再取得する。
...
提案path：`server/features/suggestions/`、`server/db/migrations/suggestions/`、`docs/01_requirements/04_api/fragments/SUGGESTIONS.json`、`docs/evidence/SUGGESTIONS/`。
