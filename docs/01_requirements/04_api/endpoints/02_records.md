...
[VisitCreate](../schemas/models.md#visitcreate)
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1visits/post)。
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1visits~1{visitId}/get)。
...
[VisitPatch](../schemas/models.md#visitpatch)
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1visits~1{visitId}/patch)。
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1visits~1{visitId}/delete)。
...
[RecordViewPage](../schemas/models.md#recordviewpage)

### 失敗応答

[共通エラー](../conventions/06_shared-http.md#共通エラー)。条件・形式は[エラー定義](../conventions/06_shared-http.md#操作別エラー)を参照。

[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1records/get)。
...
[RecordCreate](../schemas/models.md#recordcreate)
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1records/post)。
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1records~1{recordId}/get)。
...
[RecordPatch](../schemas/models.md#recordpatch)
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1records~1{recordId}/patch)。
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1records~1{recordId}/delete)。
...
[MediaPage](../schemas/models.md#mediapage)

### 失敗応答

[共通エラー](../conventions/06_shared-http.md#共通エラー)。条件・形式は[エラー定義](../conventions/06_shared-http.md#操作別エラー)を参照。

[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1records~1{recordId}~1media/get)。
...
[MediaUpload](../schemas/models.md#mediaupload)
...
[共通エラー](../conventions/06_shared-http.md#共通エラー)に加え、413 `PAYLOAD_TOO_LARGE` / 415 `UNSUPPORTED_MEDIA_TYPE` / 422 `VALIDATION_FAILED` / 409 `STATE_CONFLICT` / 412 `VERSION_CONFLICT` / 428 `VERSION_REQUIRED`。条件・形式は[エラー定義](../conventions/06_shared-http.md#操作別エラー)を参照。

[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1records~1{recordId}~1media/post)。
...
[MediaOrderInput](../schemas/models.md#mediaorderinput)
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1records~1{recordId}~1media~1reorder/post)。
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1media~1{mediaId}/get)。
...
[共通エラー](../conventions/06_shared-http.md#共通エラー)に加え、409 `NOT_READY` / 416 `RANGE_NOT_SATISFIABLE` / 503 `PROVIDER_UNAVAILABLE`。条件・形式は[エラー定義](../conventions/06_shared-http.md#操作別エラー)を参照。

[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1media~1{mediaId}~1content/get)。
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1media~1{mediaId}/delete)。
...
[TrackPointPage](../schemas/models.md#trackpointpage)

### 失敗応答

[共通エラー](../conventions/06_shared-http.md#共通エラー)。条件・形式は[エラー定義](../conventions/06_shared-http.md#操作別エラー)を参照。

[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1track-points/get)。
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1track-points/post)。
...
[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1track-points~1{pointId}/get)。
...
[TrackDelete](../schemas/models.md#trackdelete)
...
[共通エラー](../conventions/06_shared-http.md#共通エラー)に加え、412 `VERSION_CONFLICT` / 422 `VALIDATION_FAILED` / 409 `STATE_CONFLICT`。条件・形式は[エラー定義](../conventions/06_shared-http.md#操作別エラー)を参照。

[入出力例・全応答ヘッダーとSchema](../openapi.json#/paths/~1track-points~1delete-range/post)。
